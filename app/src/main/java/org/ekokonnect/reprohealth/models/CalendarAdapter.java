...
//        		v.setBackgroundResource(R.drawable.item_background_focused);
//        		v.setBackgroundResource(R.drawable.today_stroke);
//        		Log.i("Date", "Year: "+ month.get(Calendar.YEAR));
//        		Log.i("Date", "Month: "+ month.get(Calendar.MONTH));
//        		Log.i("Date", "Day: "+ month.get(Calendar.DAY_OF_MONTH));
        	} else {
        		v.setBackgroundResource(R.drawable.safe_stroke);
        	}
